...
import com.novadial.phone.activities.ContactCallHistoryActivity
...
import com.novadial.phone.databinding.ItemRecentsDateBinding
...
class RecentCallsAdapter(
    ...
    override fun submitList(list: List<CallLogItem>?) {
        ...
        super.submitList(list) {
            ...
            val totalTime = endTime - MainActivity.appStartTime
